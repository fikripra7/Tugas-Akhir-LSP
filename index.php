		...
		<div id="wrapper">
			...
			<div id="ctn-brosur">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<div class="img-brosur">
								<img src="assets/brosur1.jpeg">
							</div>
						</div>
						<div class="col-md-6">
							<div class="img-brosur">
								<img src="assets/brosur2.jpeg">
							</div>
						</div>
					</div>
				</div>
			</div> <!-- end of ctn-brosur -->
			<div id="ctn-profile">
						...
						<div class="row w-blog">
							<?php
								...
								<div class="col-md-4 box-blog" style="padding: 0 !important; margin: 0 !important;">
									<div class="box-post">
										<a href="lihat-berita.php?detail_id=<?php echo $data["id_berita"];?>"><img src="administrator/berita/hasil-upload/<?php echo $data["foto"];?>"></a>
										<div class="post-desc">
											<h4>
												<a href="lihat-berita.php?detail_id=<?php echo $data["id_berita"];?>"><?php echo $data["judul"]; ?></a>
											</h4>
											<span><i class="fas fa-calendar"></i>  <?php echo $data["waktu"]; ?></span>
											<span>
												<a class="cat" href="#ctn-latest">News</a>
											</span>
										</div>
									</div>
								</div>
